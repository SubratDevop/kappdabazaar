...
// const menuItems = [
//     { title: "Payments", icon: <MaterialIcons name="currency-rupee" size={28} color="#fff" />, path: "AdminPaymentScreen" },
//     { title: "Orders", icon: <Octicons name="package-dependents" size={28} color="#fff" />, path: "OrderMonitoringScreen" },
//     { title: "GST Reports", icon: <MaterialIcons name="receipt-long" size={28} color="#fff" />, path: "GSTReportsScreen" },
//     { title: "Manufacturers", icon: <MaterialIcons name="business" size={28} color="#fff" />, path: "ManufacturerList" },
//     { title: "Tax Settings", icon: <MaterialIcons name="settings" size={28} color="#fff" />, path: "TaxSettingsScreen" },
// ];

const SuperAdminProfileScreen = ({ route, navigation }) => {
  ...
  return (
    <ScrollView style={{ flex: 1, paddingHorizontal: 10, paddingVertical: 5 }}>
      ...
      {/* <Text style={{ fontWeight: "500", marginVertical: 5, fontSize: 18 }}>Admin Menu</Text>
            ...
            >
                {menuItems.map((item, index) => (
                    <View style={{ display: "flex", justifyContent: "center", alignItems: "center", paddingVertical: 4, }} key={index}>
                        <TouchableOpacity
                            key={index}
                            style={{
                                width: width / 3 - 20, // 3 columns, considering padding
                                height: 60,
                        ...
                        <Text style={{ fontSize: 12, fontWeight: "600", textAlign: 'center' }}>{item.title}</Text>
                    </View>
                ))}
            </View> */}
      ...
      {/* Quick Stats Section
      <Text style={{ fontWeight: "500", marginVertical: 5, fontSize: 18 }}>
        Quick Stats
      </Text>
      <View style={styles.statsContainer}>
        <View style={styles.statCard}>
          <MaterialIcons name="business" size={24} color="#132f56" />
          <Text style={styles.statNumber}>0</Text>
          <Text style={styles.statLabel}>Total Manufacturers</Text>
        </View>
        <View style={styles.statCard}>
