...
import { Modal, KeyboardAvoidingView, Platform, ScrollView, StatusBar, StyleSheet, Text, TouchableOpacity, View } from "react-native";
            ...
            >
                <View>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
                        ...
                        />
                        <Text style={{ marginLeft: 8, color: "#132f56", }}>
                            I agree to the{" "}
                            <Text
                    ...
                    >
                        <View style={{
                            ...
                            <View style={{
                                ...
                                width: "100%",
                                height: "80%",  // 👈 Enough height, scroll works
                                borderRadius: 10,
                                padding: 20,
