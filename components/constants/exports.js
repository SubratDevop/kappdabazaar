...
export const API_BASE = `https://api.kapdabazaar.in/kapda/v1/api`; // change this to your base URL
// export const API_BASE = 'http://192.168.31.24:9090/kapda/v1/api'; // change this to your base URL
